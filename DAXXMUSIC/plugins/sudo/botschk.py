...
async def bots_chk(app, message):
    msg = await message.reply_photo(photo="https://telegra.ph/file/29cc77eaa1db962053577.jpg", caption="**ᴄʜᴇᴄᴋɪɴɢ ʙᴏᴛs sᴛᴀᴛs ᴀʟɪᴠᴇ ᴏʀ ᴅᴇᴀᴅ...**")
